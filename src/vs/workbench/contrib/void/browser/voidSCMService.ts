...
class GenerateCommitMessageAction extends Action2 {
	constructor() {
		super({
			...
			title: localize2('voidCommitMessagePrompt', 'Kuunda Vibe: Generate Commit Message'),
			icon: ThemeIcon.fromId('sparkle'),
			tooltip: localize2('voidCommitMessagePromptTooltip', 'Kuunda Vibe: Generate Commit Message'),
			f1: true,
			menu: [{
...
class LoadingGenerateCommitMessageAction extends Action2 {
	constructor() {
		super({
			...
			title: localize2('voidCommitMessagePromptCancel', 'Kuunda Vibe: Cancel Commit Message Generation'),
			icon: ThemeIcon.fromId('stop-circle'),
			tooltip: localize2('voidCommitMessagePromptCancelTooltip', 'Kuunda Vibe: Cancel Commit Message Generation'),
